...
const char* fx_compressor_get_parameter_name(int index);
const char* fx_compressor_get_parameter_label(int index);
float fx_compressor_get_parameter_default(int index);
float fx_compressor_get_parameter_min(int index);
float fx_compressor_get_parameter_max(int index);
int fx_compressor_get_parameter_group(int index);
const char* fx_compressor_get_group_name(int group);
int fx_compressor_parameter_is_integer(int index);
