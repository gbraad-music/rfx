...
#define DISTRHO_PLUGIN_NAME  "RFX AmigaFilter"
#define DISTRHO_PLUGIN_URI   "https://music.gbraad.nl/regrooved/rfx-amigafilter"
...
enum Parameters {
    // Amiga Filter
    kParameterAmigaFilterType = 0,
    kParameterAmigaFilterMix,
