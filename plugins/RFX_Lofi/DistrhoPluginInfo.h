...
#define DISTRHO_PLUGIN_NAME  "RFX Lofi"
#define DISTRHO_PLUGIN_URI   "https://music.gbraad.nl/regrooved/rfx-lofi"
...
#define DISTRHO_UI_DEFAULT_WIDTH  430
#define DISTRHO_UI_DEFAULT_HEIGHT 320

enum Parameters {
    kParameterBitDepth = 0,
    kParameterSampleRateRatio,
    kParameterFilterCutoff,
    kParameterSaturation,
    kParameterNoiseLevel,
    kParameterWowFlutterDepth,
    kParameterWowFlutterRate,
    kParameterCount
};
