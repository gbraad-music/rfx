/*
 * RM1_LPF Plugin Info - MODEL 1 Low-Pass Filter
 * Copyright (C) 2024
 *
 * Based on PlayDifferently MODEL 1 DJ Mixer Contour LPF
 */
...
#define DISTRHO_PLUGIN_NAME  "RM1_LPF"
#define DISTRHO_PLUGIN_URI   "https://github.com/gbraad/rfx/RM1_LPF"
